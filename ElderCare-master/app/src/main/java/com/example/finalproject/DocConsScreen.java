...
public class DocConsScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView msg = findViewById(R.id.docmsg);
        sendButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference requestsRef = mDatabase.child("Admin").child("Requests").child("Doctor Requests").child(resultemail);
                        ...
                        if (snapshot.exists()) {
                            ...
                            switch (status) {
                                ...
                                case "Approved":
                                    ...
                                    msg.setTextSize(25);
                                    sendButton.setText("Request for doctor again");
                                    break;
                                case "Denied":
                            ...
                            mDatabase.child("Admin").child("Requests").child("Doctor Requests").child(resultemail).setValue(request);
